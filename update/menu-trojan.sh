...
clear
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" >> "$nama_file"
echo -e " ${COLBG1}  • CREATE TROJAN USER •    ${NC} " >> "$nama_file"
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" >> "$nama_file"
...
echo -e "$COLOR1 ${NC} Port        : ${tr}"  >> "$nama_file"
echo -e "$COLOR1 ${NC} Key         : ${uuid}"  >> "$nama_file"
...
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" >> "$nama_file"
echo -e "$COLOR1 ${NC} Link WS : " >> "$nama_file"
echo -e "$COLOR1 ${NC} ${trojanlink}"  >> "$nama_file"
echo -e "$COLOR1 ${NC} " >> "$nama_file"
echo -e "$COLOR1 ${NC} Link GRPC : " >> "$nama_file"
echo -e "$COLOR1 ${NC} ${trojanlink1}" >> "$nama_file"
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" >> "$nama_file"
echo "" >> "$nama_file"
